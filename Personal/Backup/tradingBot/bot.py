...
SPOT_SOCKET = "wss://stream.binance.com/ws/" + TRADE_SYMBOL + "@kline_5m"
#SPOT_SOCKET = "wss://stream.binance.com:9443/ws/manausdt@kline_5m"
FUTURES_SOCKET = "wss://fstream.binance.com/ws/busdt@kline_5m"
candle_closes = []
in_position = False
#MA
EMA1 = 25
...
balInfo = client.get_account()

bal = balInfo['balances']
