...
public class SnakeUI extends JFrame {
	...
	public SnakeUI() {
		...
		setTitle("Your title here"); // TODO Change to your own title
    ...
    /**
     * Return the board object, we need this method so it can
     * be called from the main method below
     */
    ...
    /**
     * This is the main method that the program execution starts
     * from. This basically sets up the UI and makes it visible.
     */
